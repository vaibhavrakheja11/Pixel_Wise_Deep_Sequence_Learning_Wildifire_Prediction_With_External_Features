...
from PIL import Image
im = Image.open('data_f/eval_div/Data_slice_102/fire_result.tif')
np.array(im).shape
...
t = np.array(Image.open('data_f/eval_div/Data_slice_104/fire_result.tif').getdata()).reshape([128,128])
...
figure()
plt.imshow(np.array(videos[0][:,:,5]).reshape([128,128]), cmap='gray')
figure()

plt.imshow(np.array(videos[0][:,:,1]).reshape([128,128]), cmap='gray')
figure()

plt.imshow(np.array(videos[0][:,:,2]).reshape([128,128]), cmap='gray')
figure()

plt.imshow(np.array(videos[0][:,:,3]).reshape([128,128]), cmap='gray')
figure()
plt.imshow(np.array(videos[0][:,:,6]).reshape([128,128]), cmap='gray')
figure()
...
#ConvoLSTM 2D with Gaussian Noise
